...
SEARCH_VENUES_BY_LETTER_NJK = """
{% extends "application/base.html" %}

{% block canonical_link %}
  <link rel="canonical" href="{{ domain }}search/venues/{{letter | urlencode}}">
{% endblock %}

{% block meta_description %}
  <meta name="description" content="Browse the top music venues with names starting with {{letter}}. Find tickets, tour dates, artist information, and more.">
{% endblock %}

{% block title %}
  Concert Venue Names Starting With {{letter}} | Hypebot
{% endblock %}

{% block styles %}
  <style>
    {% include "search/venues/styles.css" %}
  </style>
{% endblock %}
...
{% block content %}
  <div class="artistList">
    ...
    <div class="artistSections">
      {% for venue in venues %}
        <div>
          <a class="artistLink" href="/venue/{{ letter | urlencode }}/{{ venue.id }}-{{ venue.nameSlug }}">
            {{ venue.name }}
          </a>
        </div>
      {% endfor %}
...
TEMPLATES = {
    "search/venues/byLetter.njk": SEARCH_VENUES_BY_LETTER_NJK,
    "search/venues/styles.css": SEARCH_VENUES_STYLES_CSS,
